...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhịp tim của Lập = " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-heart-alt"></i>&nbsp;Nhịp tim như vậy là vì ...';
document.querySelector('.Description .modal-body').innerHTML = 'Vẫn còn nhớ mãi một người chẳng thể nào quên =))  <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";
author.innerHTML = "Visit my Facebook ♥<a href='https://www.facebook.com/ThoConXinhXan.1401933'> L-LEADER <a>";
